...
def generate_expense_report(user, expenses, from_date, to_date, salary=0):
    ...
    # ── Category table: 3 columns, explicit widths that fit USABLE_W ─────────
    # Pie takes ~200pt; category table gets the rest
    cat_col_w = [5.5 * cm, 3.5 * cm, 2.5 * cm]   # total ~11.5cm = ~326pt
